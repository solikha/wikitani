    ...
    <body class="no-skin">
        <div class="navbar navbar-default" id="navbar" style="background-image: url('<?= base_url() ?>themes/aceadmin/images/bg belgia-02.png');background-size: 1350px 100px ;height: 100px">
            ...
            <div class="navbar-container" id="navbar-container">
                <button type="button" class="navbar-toggle menu-toggler pull-left btn-grey" id="menu-toggler">
                    ...
                    <ul class="nav"> 
                        <li class="">
                            ...
                            <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close my-dropdown">
                                ...
                                <li>
                                    <a href="<?php echo $basedir . index_page(); ?>/login/logout">
        ...
        <div class="main-container" id="main-container">
            ...
            <div class="main-container-inner">
                <div class="sidebar responsive <?php echo getArrayDef($menuoptions, 'sidebar_class'); ?>" id="sidebar">
                    <div style="background-image: url('<?= base_url() ?>themes/aceadmin/images/bg belgia-12.png'); background-size: 200px 800px">
                        <script type="text/javascript">
                            try {
                ...
                <div class="main-content">	
                    ...
                    <div class="page-content" id="page-content">
                        <div class="row">
						<?php if($jumlah_artikel_tersunting != 0){; ?> 
						<div class="col-md-12">
						    <div class="btn-minier infobox-red" style="float:right;">							
										<div class="infobox-icon ">
										<i class="fa fa-comment"></i>
										<span><?php echo $jumlah_artikel_tersunting; ?> <a href="improvement_page" style="color:red;"> Artikel telah disunting user</a></span>
