...
//            $sessData = $this->mlogin->getSessionData();
            ...
            if ($sessData===false){
				...
				//mendapatkan informasi user editing
				$user_editing_info= $this->mmenu->getUserEditingInfo();
                ...
                if ($menuinfo === false) {
					...
					//memberi notif suntingan artikel oleh
					$jumlah_artikel_tersunting=$user_editing_info["jumlah_artikel_tersunting"];
                    $data["jumlah_artikel_tersunting"]=$jumlah_artikel_tersunting;					
