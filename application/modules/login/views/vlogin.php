...
<html lang="en">
    <head>
        ...
        <style>
            .login-layout {
                background-image: url('<?php echo base_url(); ?>themes/aceadmin/images/bg1.png');background-size: 100% 120%;
            }
            .title-text {
                color: black;
            }
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            ...
                            <div class="position-relative">
                                <div id="login-box" class="login-box visible" style="background-color: rgba(60, 0, 110, 0.40);">
                                    <div class="">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <button type="button" class="width-35 pull-right btn btn-sm btn-primary" 
													 ...
													 <a class="btn btn-sm btn-link " style="color:white!important"href="E:\KKP\contoh\index.html">
                                                        back to home</a>
