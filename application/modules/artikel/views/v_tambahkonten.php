...
<div class="col-md-12" style=" backgroun-color:#EEEEEE">
   <div class="row" style="margin-bottom:10px; ">
      <div class="col-md-3">
         ...
         <div class="row" style="margin-right:3px">
            <form method="post" action="<?php echo base_url()?>/index.php/artikel/saveartikel">
               <select class="form-control" name="kategori_nama" id="kategori_nama">
                  <?php
      ...
      <div class="row" style="margin-right:3px">
      <select class="form-control" name="subkategori_nama" id="subkategori_nama">
      </select>
      </div>
      </div>
      <div class="col-md-3">
      ...
      <div class="row" style="margin-right:3px">
      <input type="text" class="form-control crud-param" placeholder="" name="judul_artikel" id="judul_artikel" style="" >
      </div>
      </div>
      <div class="col-md-3">
