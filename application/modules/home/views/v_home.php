    ...
    <div class="col-sm-8 col-md-offset-2">
        ...
        <div class="infobox infobox-red">
            ...
            <div class="infobox-data">
                ...
                <div class="infobox-content">Artikel Diproses</div>
            </div>
        ...
        <div class="infobox infobox-blue">
            ...
            <div class="infobox-data">
                ...
                <div class="infobox-content">Artikel Telah Disetujui</div>
            </div>
        ...
        <div class="infobox infobox-pink">
            ...
            <div class="infobox-data">
                ...
                <div class="infobox-content">Jumlah User Terdaftar</div>
            </div>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead class="thin-border-bottom">
                                <tr>
                                    ...
                                    <th> Nama User</th>
                                    <th class="hidden-480"> Judul Konten </th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $i = 1; ?>
